...
import com.itch.cartillaanimal.Registro;
import com.itch.cartillaanimal.RegistroUsuario;

public class Cartilla extends AppCompatActivity {

    Button btnRecordatorio, btnAtras;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent atras;
                atras = new Intent(Cartilla.this, Home.class);
                startActivity(atras);
                finish();
            }
        });
        ...
        btnRecordatorio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent recordatorio;
                recordatorio = new Intent(Cartilla.this, Recordar.class);
